		...
		<main class="main">
			<div class="container main__container">
				<div class="car-info-width">
					<div class="car-info">
						<div class="swiper r580Swiper">
							<div class="swiper-wrapper">
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/r580/r5801.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/r580/r5802.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/r580/r5803.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/r580/r5804.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/r580/r5805.jpg"></div>
							</div>
					...
					<div class="preview-price">
						<strong>Стоимость за сутки:</strong> 12000руб
					</div>
					<div class="preview-deposit">
						<strong>Залог: </strong>50000руб
					</div>
