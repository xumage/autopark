		...
		<header id="header-next">
			<div class="container header__container">
				...
				<nav class="header__nav">
					<ul class="nav-ul">
						<li><a class="header__nav-link" href="index.html#about">О нас</a></li>
						<li><a class="header__nav-link" href="index.html#advantages-title">Преимущества</a></li>
						<li><a class="header__nav-link" href="index.html#gallery-title">Автопарк</a></li>
						<li><a class="header__nav-link" href="index.html#faq-title">Вопрос - ответ</a></li>
					</ul>
				</nav>
				<div class="social">
		...
		<main class="main">
			<div class="container main__container">
				<div class="car-info-width">
					<div class="car-info">
						<div class="swiper nextSwiper">
							<div class="swiper-wrapper">
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/next/next1.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/next/next2.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/next/next3.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/next/next4.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/next/next5.jpg"></div>
							</div>
					...
					<div class="preview-price">
						<strong>Стоимость за сутки:</strong> 6000руб
					</div>
					<div class="preview-deposit">
						<strong>Залог: </strong>30000руб
					</div>
