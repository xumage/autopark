		...
		<main class="main">
			<div class="container main__container">
				<div class="car-info-width">
					<div class="car-info">
						<div class="swiper ducatoSwiper">
							<div class="swiper-wrapper">
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/ducato/ducato1.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/ducato/ducato2.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/ducato/ducato3.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/ducato/ducato4.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/ducato/ducato5.jpg"></div>
							</div>
						...
						<div class="specifications">
							...
							<div class="specifications-text">
								...
								<p>Стоячих мест: 8</p>
								<p>Сидячих мест: 16</p>
								<p>Инвалидных мест: 1</p>
								<p>Объём двигателя: 2,3 л</p>
								<p>Тип двигателя: Дизель</p>
								<p>Коробка передач: Механика</p>
								<p>Привод: Задний</p>
								<p>Комплектация: Максимальная</p>
								<p>Тип кузова: Пассажирский автобус</p>
					...
					<div class="preview-price">
						<strong>Стоимость за сутки:</strong> 8000руб
					</div>
