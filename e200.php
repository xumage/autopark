		...
		<main class="main">
			<div class="container main__container">
				<div class="car-info-width">
					<div class="car-info">
						<div class="swiper e200Swiper">
							<div class="swiper-wrapper">
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/e200/e2001.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/e200/e2002.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/e200/e2003.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/e200/e2004.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/e200/e2005.jpg"></div>
							</div>
					...
					<div class="preview-price">
						<strong>Стоимость за сутки: </strong>10000руб
					</div>
