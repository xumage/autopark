			...
			<div class="container main__container">
				<div class="car-info-width">
					<div class="car-info">
						<div class="swiper loganSwiper">
							<div class="swiper-wrapper">
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/granta/granta1.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/granta/granta4.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/granta/granta2.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/granta/granta3.jpg"></div>
								<div class="swiper-slide"><img class="cars-preview-img" src="autos img/granta/granta5.jpg"></div>
							</div>
					...
					<div class="preview-price">
						<strong>Стоимость за сутки:</strong> 3500руб
					</div>
					<div class="preview-deposit">
						<strong>Залог: </strong>10000руб
					</div>
				...
				<form action="/send.php" method="post" class="form">
					...
					<div class="form-row">
						<div class="accept-btn">
							<label>
								<input class="accept-btn-inpt" type="checkbox" name="accept" required>C <a target="_blank"
									class="doc-btn" href="politika-conf.html">политикой конфиденциальности</a> и <a target="_blank"
									class="doc-btn" href="dogovor.html">договором</a> аренды ознакомлен
							</label>
						</div>
					</div>
					<div class="form-row">
